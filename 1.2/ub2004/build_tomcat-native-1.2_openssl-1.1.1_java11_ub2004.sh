...
cp -a /tmp/openssl111/usr/lib/x86_64-linux-gnu/lib*.so* usr/lib/x86_64-linux-gnu/
...
sleep 2
cd /tmp
tar -Jcvf /tmp/"libtcnative-${_tcn12_ver}_openssl-${_openssl111_ver}_java11-1.ub2004.x86_64.tar.xz" tomcat-native
echo
sleep 2
cd /tmp
rm -fr "${_tmp_dir}"
